...
public class DateUtil {
    ...
    public static String formatDate(String date, String patter) throws ParseException {
        Date d = parseDate(date);
    ...
    public static Date getRandomDate(String start, String end) throws ParseException {
